  ...
  <div className="text-slate-900">
    <section className="mx-auto max-w-4xl">
      <header className="mb-6">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900">Drivers of Residential Real‑Estate Prices in Poland: An Exploratory Data Analysis</h2>
        ...
        <div className="space-y-8 text-slate-900">
          ...
          <section id="price-dist">
            ...
            <figure className="space-y-2">
              ...
              <figcaption className="text-sm text-slate-600">Right-skewed with a long upper tail.</figcaption>
            </figure>
          </section>
          ...
          <section id="price-area">
            ...
            <figure className="space-y-2">
              ...
              <figcaption className="text-sm text-slate-600">Prices increase with area but with wide variance.</figcaption>
            </figure>
          </section>
          ...
          <section id="regional">
            ...
            <figure className="space-y-2">
              ...
              <figcaption className="text-sm text-slate-600">Mazowieckie has the most listings.</figcaption>
            </figure>
            <figure className="space-y-2">
              ...
              <figcaption className="text-sm text-slate-600">Higher medians around Warsaw and coastal regions.</figcaption>
            </figure>
          </section>
          ...
          <section id="building">
            ...
            <figure className="space-y-2">
              ...
              <figcaption className="text-sm text-slate-600">Type matters for pricing.</figcaption>
            </figure>
          </section>
          ...
          <section id="correlations">
            ...
            <figure className="space-y-2">
              ...
              <figcaption className="text-sm text-slate-600">Price relates to area and regional salaries.</figcaption>
            </figure>
          </section>
          ...
          <section id="ppsqm">
            ...
            <figure className="space-y-2">
              ...
              <figcaption className="text-sm text-slate-600">Affordability gaps persist by region.</figcaption>
            </figure>
          </section>
          ...
          <section id="appendix" className="pt-4 border-t">
            ...
            <p className="text-sm">Download original document: <a className="text-blue-600 underline" href="/articles/original_article.docx" download>original_article.docx</a></p>
          </section>
        </div>
      </div>
    </section>
  ...
  <div className="text-slate-900">
    <section className="mx-auto max-w-4xl">
      <header className="mb-6 text-center">
        ...
        <p className="mt-2 text-slate-700">A focused case study aligned with the portfolio styling.</p>
      </header>
      ...
      <article className="space-y-8">
        ...
        <section>
          ...
          <img src="/articles/price_distribution.png" alt="Distribution of Prices" className="rounded-xl border border-slate-200 w-full" />
          <img src="/articles/area_distribution.png" alt="Distribution of Area" className="rounded-xl border border-slate-200 w-full" />
          <p className="mt-3">Geographical activity is uneven. Mazowieckie dominates by listing counts.</p>
          <img src="/articles/listings_per_voivodeship.png" alt="Number of Listings by Voivodeship" className="rounded-xl border border-slate-200 w-full" />
        </section>
        ...
        <section>
          ...
          <img src="/articles/median_price_per_m2.png" alt="Price per Square Meter by Voivodeship" className="rounded-xl border border-slate-200 w-full" />
        </section>
...
const Card: React.FC<{ a: Article; onOpen: (a: Article) => void }> = ({ a, onOpen }) => (
  <div className="bg-white border border-sage-100 overflow-hidden transition hover:border-sage-200 hover:shadow-md w-full">
    ...
    <div className="p-6 space-y-4">
      <h3 className="font-serif text-xl font-light text-sage-500">{a.title}</h3>
      <p className="text-xs uppercase tracking-wider text-sage-300">{a.date}</p>
      <p className="text-sm text-sage-400 font-light">{a.summary}</p>
      <div className="flex flex-wrap gap-2">
        {a.tags?.map((t) => (
          <span key={t} className="text-xs px-3 py-1 border border-sage-200 text-sage-400 uppercase tracking-wider">
            {t}
          </span>
        ))}
      </div>
      <button
        onClick={() => onOpen(a)}
        className="mt-3 px-6 py-2 bg-sage-500 hover:bg-sage-400 text-cream-50 text-xs uppercase tracking-wider font-medium transition-colors duration-200 flex items-center gap-2"
...
const Modal: React.FC<{ open: boolean; onClose: () => void; children: React.ReactNode }> = ({ open, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-5xl max-h-[90vh] bg-white text-slate-900 rounded-2xl overflow-hidden shadow-2xl">
              <div className="sticky top-0 h-16 flex items-center justify-between px-6 border-b border-sage-200 bg-white z-10">
                <h2 className="text-lg font-serif font-light text-sage-500">Full Article</h2>
                <button 
                  onClick={onClose} 
...
const ArticlesSection: React.FC = () => {
  ...
  return (
    <section id="articles" className="section-padding bg-cream-50">
      <div className="mx-auto max-w-6xl px-4">
        <header className="mb-12 text-center">
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-light text-sage-500 mb-4">Articles</h2>
          <p className="text-sage-400 font-light">Research, notes, data visualizations.</p>
        </header>
