...
const Blog = () => {
  ...
  return (
    <section id="notes" className="section border-t border-white/[0.06] bg-ink-800/40">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-mist-300 font-light max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {blogPosts.map((post, index) => (
            <article
              key={index}
              className="bg-white/[0.03] border border-white/[0.07] overflow-hidden hover:border-white/10 hover:shadow-md transition-all duration-300"
            >
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="px-3 py-1 border border-white/10 text-white text-xs uppercase tracking-wider">
                    {post.category}
                  </span>
                  <span className="text-mist-500 text-xs uppercase tracking-wider">
                    {post.readTime}
                  </span>
                </div>
                
                <h3 className="text-2xl font-light text-white mb-3 line-clamp-2">
                  {post.title}
                </h3>
                
                <p className="text-mist-300 mb-6 line-clamp-3 font-light">
                  {post.excerpt}
                </p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="text-white hover:text-mist-300 font-medium text-xs uppercase tracking-wider transition-colors flex items-center gap-2"
                  >
                    Read More 
        ...
        {selectedPost !== null && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setSelectedPost(null)}>
            ...
            <div 
              className="relative w-full max-w-4xl max-h-[90vh] bg-white/[0.03] overflow-hidden shadow-2xl"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="sticky top-0 h-16 flex items-center justify-between px-6 border-b border-white/10 bg-white/[0.03] z-10">
                <span className="px-3 py-1 border border-white/10 text-white text-xs uppercase tracking-wider">
